    ...
    dict(
        ...
        policies=[
            [
                dict(
                    type='Resize',
                    img_scale=list(zip([int(_a) for _a in 1920 * linspace(0.2, 1.0, 30) // 32 * 32], [1920] * 30)),
            ...
            [
                dict(
                    type='Resize',
                    img_scale=list(zip([int(_a) for _a in 1920 * linspace(1.0, 4.0, 30) // 32 * 32], [1920] * 30)),
                    multiscale_mode='value',
                    keep_ratio=True),
                dict(
                    type='RandomCrop',
                ...
                dict(
                    type='Resize',
                    img_scale=list(zip([int(_a) for _a in 1920 * linspace(0.4, 1.0, 10) // 32 * 32], [1920] * 10)),
                    multiscale_mode='value',
                    override=True,
                    keep_ratio=True)
            ]
...
data = dict(
    samples_per_gpu=2,  # TODO: consider increasing this
    workers_per_gpu=2,  # TODO: consider increasing this
